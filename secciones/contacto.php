 ...
 <div class="alert alert-danger alert-dismissible fade show" role="alert">
          ...
          <strong>Error!</strong> Los campos <b>Nombre, Apellido y Email</b> son obligatorios
  </div>
<?php
endif;
?>
...
<!--FORMULARIO-->
        ...
        <form class="formulario" action="procesar-registro.php" method="post">
           ...
           <textarea name="mensaje"  rows="3"  class="form-control" >
           </textarea>
            <br>
