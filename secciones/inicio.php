            ...
            <div class= "row">
               <div class= "col-md-6">
                 ...
                 <p><span>Mantenete informado, sobre las novedades de "Angry Zeta & The Hillbullys". Pronto 
                     subiremos información sobre nuestra segunda Gira por Europa 2019. Podés aprovechar también para ver
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <img class="img-fluid" src="img/sorteo.jpg" alt="Flyer de Gira" width="500" >
        </div>
