                ...
                <form action="{{route("merch.update",$merch->id)}}" enctype="multipart/form-data" method="POST" class=" p-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="precio" id="precio" class="form-control" placeholder="Ingrese el precio del producto" value="{{isset($merch)? $merch->precio : old('precio')}}">
                        </div>

                       <div class="form-check">
                            <label for="stock">Stock: </label>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="stock" id="inlineRadio1" value="option1">
                                <label class="form-check-label" for="inlineRadio1">Si</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="stock" id="inlineRadio2" value="option2">
